from flask import Blueprint, request, jsonify, current_app, send_file  # type: ignore[import-not-found]
from geoalchemy2.shape import to_shape, from_shape  # type: ignore[import-not-found]
...
def moderate():
    ...
    password_hash = data.get('admin_password')
